...
final class PasteboardMonitor {
    ...
    private func poll() {
        ...
        if AppFilter.shouldSkip(bundleID: front.bundleID, excluded: settings.excludedBundleIDs) {
            return
        }

        // Respect macOS "concealed"/transient markers used by password managers.
    ...
    /// True when the current pasteboard is marked transient/concealed (passwords).
